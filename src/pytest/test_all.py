...
def test_circle_area_tester(myinput,myref):
...
def test_square_area_tester(myinput,myref):
...
def test_circle_circumference_tester(myinput,myref):
...
def test_square_circumference_tester(myinput,myref):
